...
public final class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSala.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        btnSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/comedor.png"))); // NOI18N
        ...
        btnVentas.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        btnVentas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/pedido-en-linea (1).png"))); // NOI18N
        ...
        btnConfig.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        btnConfig.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/configuraciones.png"))); // NOI18N
        ...
        LabelVendedor.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        LabelVendedor.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        LabelVendedor.setText("ADMINISTRADOR");

        tipo.setForeground(new java.awt.Color(255, 255, 255));

        btnUsuarios.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        ...
        btnPlatos.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        btnPlatos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/olla-caliente.png"))); // NOI18N
        ...
        txtNombreSala.setBackground(new java.awt.Color(204, 204, 255));
        txtNombreSala.setBorder(null);
        jPanel10.add(txtNombreSala, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 190, 30));

        btnRegistrarSala.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        btnRegistrarSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/disco-flexible.png"))); // NOI18N
        ...
        jPanel10.add(btnRegistrarSala, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 140, 40));

        btnActualizarSala.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        btnActualizarSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/actualizar-pagina.png"))); // NOI18N
        ...
        jPanel10.add(btnActualizarSala, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, -1, 40));

        btnNuevoSala.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        btnNuevoSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/documento.png"))); // NOI18N
        btnNuevoSala.setText("AGREGAR");
        btnNuevoSala.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNuevoSalaActionPerformed(evt);
            }
        });
        jPanel10.add(btnNuevoSala, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, 150, 40));

        btnEliminarSala.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        btnEliminarSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/borrar_1.png"))); // NOI18N
        ...
        jPanel10.add(btnEliminarSala, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 140, 40));
        ...
        jPanel10.add(jPanel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 190, 2));

        jPanel38.setBackground(new java.awt.Color(153, 0, 0));
        ...
        jPanel38.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 300, 30));

        jPanel10.add(jPanel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 350, 35));
        ...
        jPanel10.add(jPanel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 190, 2));

        txtMesas.setBackground(new java.awt.Color(204, 204, 255));
        txtMesas.setBorder(null);
        jPanel10.add(txtMesas, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 130, 190, 30));

        jLabel19.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        jLabel19.setText("MESAS:");
        jPanel10.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, -1, -1));

        jPanel4.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 350, 380));
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/porcentaje-de-beneficio.png"))); // NOI18N
        ...
        btnEliminarTempPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/borrar_1.png"))); // NOI18N
        ...
        totalFinalizar.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/porcentaje-de-beneficio.png"))); // NOI18N
        ...
        btnPdfPedido.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnPdfPedido.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/pdf_1.png"))); // NOI18N
        btnPdfPedido.setText("PDF");
        ...
        jPanel25.add(txtIdHistorialPedido, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 450, 50, -1));
        ...
        TablePedidos.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jLabel16.setFont(new java.awt.Font("MS UI Gothic", 1, 36)); // NOI18N
        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel16.setText("HISTORIAL DE PEDIDOS");
        jPanel6.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 30, 420, -1));
        ...
        jLabel32.setFont(new java.awt.Font("Trebuchet MS", 1, 48)); // NOI18N
        jLabel32.setText("DATOS DE LA EMPRESA");
        jPanel7.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 20, -1, -1));
        ...
        txtDireccionConfig.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jLabel31.setFont(new java.awt.Font("Trebuchet MS", 3, 16)); // NOI18N
        ...
        btnActualizarConfig.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        ...
        btnIniciar.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        ...
        txtNombrePlato.setBackground(new java.awt.Color(204, 204, 255));
        ...
        txtPrecioPlato.setBackground(new java.awt.Color(204, 204, 255));
        ...
        btnGuardarPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/disco-flexible.png"))); // NOI18N
        ...
        btnEditarPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/actualizar-pagina.png"))); // NOI18N
        ...
        btnEliminarPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/borrar_1.png"))); // NOI18N
        ...
        btnNuevoPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/documento.png"))); // NOI18N
        ...
        jLabel40.setText("PLATOS DEL DIA");
        ...
        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 130, 1070, 590));

        jPanel3.setBackground(new java.awt.Color(255, 153, 0));

        jLabel38.setBackground(new java.awt.Color(255, 255, 255));
        jLabel38.setFont(new java.awt.Font("Zilla Slab", 3, 48)); // NOI18N
        jLabel38.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/restaurante (3)_1.png"))); // NOI18N
        jLabel38.setText("EL PEÑONCITO");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(249, 249, 249)
                .addComponent(jLabel38, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 0, 1070, 130));
    ...
    private void panelSalas() {
        ...
        for (int i = 0; i < Listar.size(); i++) {
            ...
            JButton boton = new JButton(Listar.get(i).getNombre(), new ImageIcon(getClass().getResource("/Img/ingresar.png")));
    ...
    private void panelMesas(int id_sala, int cant) {
        for (int i = 1; i <= cant; i++) {
            int num_mesa = i;
            //verificar estado
            JButton boton = new JButton("MESA N°: " + i, new ImageIcon(getClass().getResource("/Img/mesa (1).png")));
            boton.setHorizontalTextPosition(JButton.CENTER);
            boton.setVerticalTextPosition(JButton.BOTTOM);
